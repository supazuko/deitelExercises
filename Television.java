public class Television{
    ...
    public Television (boolean isOn, boolean isAsleep, String brandName, int currentChannel, int currentVolume){
        this.isOn = isOn;
	...
	public void setAsleep(boolean isOnStandBy){
        	isAsleep = isOnStandBy;
    	}
